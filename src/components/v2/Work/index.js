...
const workExperience = [
    {
      id: 1,
      companyName: 'DataStealth',
      title: 'Full Stack Engineer (Full-time), July 2024 - Present',
      summary: 'Collaborated with the team to build and maintain a data discovery and security platform, including authentication flows, a data lineage and classification API, sensitive-data scanning and discovery pipelines, and policy-based data-masking workflows.',
      technologyUsed: 'Node.js, TypeScript, Express, Kysely, React, PostgreSQL, Redis, RabbitMQ, JDBC, Nx, Okta, HashiCorp Vault, AWS, Docker, Git, Jira'
    },
    {
      id: 2,
      companyName: 'ShowKonnect',
      title: 'Full Stack Engineer (Contract), July 2023 - July 2024',
